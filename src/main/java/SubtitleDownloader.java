...
//      * downloadSubtitle - Given a downloadSubtitleURL and PathtoDownload, downloads the zip file, extracts the contents and saves the files in the given Path to Download
